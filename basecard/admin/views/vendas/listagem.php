        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php while($linhas_vendas = mysqli_fetch_assoc($sql_blog_config)){ ?>
                    <tr>
                        <td><a href="https://<?php echo $host;?>/admin/control.php?url=5&codigo=<?php echo $linhas_vendas['codigo'];?>" target="_BLANK"><?php echo $linhas_vendas['id'];?></a></td>
                        ...
                        <td><a href="https://<?php echo $host;?>/admin/control.php?url=5&codigo=<?php echo $linhas_vendas['codigo'];?>" class="btn btn-<?php if($linhas_vendas['status'] == '2'){ echo 'success'; } else { echo 'danger'; }?>" target="_BLANK"><?php if($linhas_vendas['status'] == '2'){ echo '<b>Aprovado</b>'; } else { echo '<b>Pendente</b>'; }?></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
